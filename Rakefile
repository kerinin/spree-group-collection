...
desc 'Generate documentation for the object_group extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'ObjectGroupExtension'
...
desc 'Test the object_group extension.'
...
namespace :test do
  desc 'Functional test the object_group extension.'
  ...
  desc 'Unit test the object_group extension.'
